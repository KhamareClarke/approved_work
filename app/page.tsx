  ...
  return (
    <div suppressHydrationWarning>
      ...
      <section className="relative bg-gradient-to-br from-blue-900 to-blue-800 text-white overflow-hidden">
        ...
        {/* Trust Bar */}
        <div className="relative border-b border-blue-700/30">
          <div className="max-w-6xl mx-auto px-6 py-3">
            <div className="flex items-center justify-center gap-8 text-sm">
              <div className="flex items-center gap-2">
                <Shield className="w-4 h-4 text-green-400" />
                <span className="font-medium">10,000+ Verified</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">
                  ...
                  <span className="block text-yellow-400 mt-1">Tradesperson</span>
                  <span className="block text-blue-100 mt-1">in 60 Seconds ⚡</span>
                </h1>
