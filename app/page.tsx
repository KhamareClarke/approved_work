...
export default function Home() {
  ...
  return (
    <div suppressHydrationWarning>
      ...
      <section className="relative bg-gradient-to-br from-blue-800 via-blue-900 to-blue-950 text-white overflow-hidden shadow-xl">
        <div className="absolute inset-0 bg-gradient-to-tr from-blue-900/70 via-blue-800/80 to-blue-700/60"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10 md:py-14 flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
          {/* Left Column: Text & Search */}
          <div className="flex-1 z-10 flex flex-col items-start justify-center text-left">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-[1.15] tracking-tight mb-2 text-balance">
              <span className="text-[#fdbd18]">Find</span>{' '}
              <span className="bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">Trusted</span>{' '}
              <span className="text-[#fdbd18] tracking-wide">Approved</span>{' '}
              <span className="block sm:inline" />
              <span className="text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">local</span>{' '}
              <span className="bg-gradient-to-r from-[#fdbd18] to-white bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">Trades</span><span className="bg-gradient-to-r from-[#fdbd18] to-white bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">people</span>
            </h1>
            <p className="mt-1 font-bold text-base md:text-lg mb-3" style={{ fontSize: '1.05rem', color: '#f8fafc', textShadow: '0 1px 8px #0f172a' }}>
              Instant <span className="text-[#fdbd18] font-semibold">AI</span> quotes from vetted, insured local tradespeople — no cowboy builders.
            </p>
            <div className="w-full max-w-lg">
              <Dialog>
                <DialogTrigger asChild>
                  <div id="ai-quote-trigger" className="flex items-center bg-white rounded-xl shadow-lg p-2 pr-2 mb-4 cursor-pointer group">
                    ...
                    <input
                      ...
                      className="flex-1 py-3 px-4 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none text-lg bg-transparent cursor-pointer group-hover:ring-2 group-hover:ring-blue-400"
                      readOnly
                    />
                    <Button
                      type="button"
                      className="ml-2 bg-[#fdbd18] text-blue-900 font-extrabold hover:brightness-95 rounded-xl px-5 h-12 text-base shadow-md hover:shadow-yellow-400/50 transition-shadow"
                    >
                      Search
                    </Button>
                  </div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3 text-sm">
                ...
                <span className="inline-flex items-center gap-2 bg-white/10 backdrop-blur px-3 py-1.5 rounded-full border border-white/20">
                  <Shield className="w-4 h-4 text-[#fdbd18]" /> Insurance Guaranteed
                </span>
                <span className="flex items-center gap-2 bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-xs font-semibold">
                  <Star className="w-4 h-4" /> Rated 5.0 by 50,000+ Customers
                </span>
              </div>
            </div>
            <div className="mt-8">
          ...
          <div className="flex-1 z-10 flex items-center justify-center relative min-h-[400px] overflow-hidden">
            <img
              src="/hero.png"
              alt="Trusted Tradespeople"
              className="w-full max-w-sm sm:max-w-md h-[300px] sm:h-[350px] md:h-[400px] rounded-3xl shadow-2xl object-cover object-top"
              style={{ objectFit: 'cover', objectPosition: 'top', margin: 0, padding: 0 }}
            />
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-yellow-500 text-blue-900 px-6 py-3 rounded-full shadow-lg font-semibold flex items-center gap-2 z-20 border-2 border-white">
              <Shield className="w-5 h-5" /> All Trades Verified
            </div>
          </div>
        </div>
      </section>
