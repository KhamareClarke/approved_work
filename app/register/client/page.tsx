    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-yellow-50 flex items-center justify-center p-4">
          ...
          <div className="order-1 md:order-1 p-[1.5px] rounded-3xl bg-gradient-to-br from-blue-200/70 to-yellow-200/70 shadow-2xl">
            <Card className="rounded-3xl border border-white/70 bg-white/95 backdrop-blur shadow-xl">
              <CardHeader className="text-center pb-6">
                ...
                <CardTitle className="text-3xl font-bold text-[#fdbd18] mb-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black text-base font-semibold rounded-lg shadow"
              >
        ...
        <div className="order-2 md:order-2 flex flex-col gap-4">
          ...
          {/* Additional sales pitch cards */}
          <div className="p-[1.5px] rounded-3xl bg-gradient-to-br from-blue-200/70 to-yellow-200/70 shadow-xl">
            <div className="relative bg-white/95 backdrop-blur rounded-3xl border border-white/70 p-6 transition-transform duration-200 hover:-translate-y-[2px]">
              <div className="absolute top-0 left-0 right-0 h-1 bg-[#fdbd18] rounded-t-3xl" />
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Everything you need</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-blue-700" /> Secure messaging</li>
                <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-600" /> Quotes & bookings in one place</li>
                <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-[#fdbd18]" /> UK‑wide coverage</li>
              </ul>
            </div>
          </div>
          ...
          <div className="p-[1.5px] rounded-3xl bg-gradient-to-br from-blue-200/70 to-yellow-200/70 shadow-xl">
            <div className="relative bg-white/95 backdrop-blur rounded-3xl border border-white/70 p-6 transition-transform duration-200 hover:-translate-y-[2px]">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-green-600" /> Vetted & insured pros</li>
                <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-blue-700" /> Clear pricing</li>
                <li className="flex items-center gap-2"><CheckCircle className="h-4 w-4 text-[#fdbd18]" /> Dedicated support</li>
              </ul>
            </div>
          </div>
          ...
          <div className="p-[1.5px] rounded-3xl bg-gradient-to-br from-blue-200/70 to-yellow-200/70 shadow-xl">
            <div className="relative bg-white/95 backdrop-blur rounded-3xl border border-white/70 p-6 transition-transform duration-200 hover:-translate-y-[2px]">
              ...
              <ol className="space-y-3 text-sm text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="inline-flex h-6 min-w-6 items-center justify-center rounded-full bg-blue-600 text-white text-xs font-bold">1</span>
                  Tell us what you need and your location
                </li>
                <li className="flex items-start gap-3">
                  <span className="inline-flex h-6 min-w-6 items-center justify-center rounded-full bg-[#fdbd18] text-black text-xs font-bold">2</span>
                  Get matched with verified, top‑rated pros
                </li>
                <li className="flex items-start gap-3">
                  <span className="inline-flex h-6 min-w-6 items-center justify-center rounded-full bg-green-600 text-white text-xs font-bold">3</span>
