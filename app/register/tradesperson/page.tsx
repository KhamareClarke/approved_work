...
export default function TradespersonSignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-yellow-50 py-12">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-6 md:gap-8 items-start">
        ...
        <div className="order-1 md:order-1 p-[1.5px] rounded-3xl bg-gradient-to-br from-blue-200/70 to-yellow-200/70 shadow-2xl">
          <div className="bg-white/95 backdrop-blur rounded-3xl border border-white/70 shadow-xl overflow-hidden">
            {/* Header lockup */}
